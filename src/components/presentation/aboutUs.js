			...
			<div className="section contact-section">
				<div className="  contact-left-section ">
					...
					<h2 className="email text-large">
						<a rel="noreferrer" target="_blank" href="mailto:prateekrohilla4.pr@gmail.com"> prateekrohilla4.pr@gmail.com</a>
					</h2>

					<p className="happy-to-help">
						We are here to answer any questions regarding our resume generator, do not hesitate to contact
						us for any reason. We will respond in less than 24 hours from receipt of the email. Thanks for
						trusting us
					</p>
				</div>
